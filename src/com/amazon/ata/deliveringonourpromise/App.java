...
public class App {
    ...
    public static PromiseDao getPromiseDao() {
        List<PromiseClient> newList = new ArrayList<>();
        newList.add(getDeliveryPromiseServiceClient());
        newList.add(getPromise());
        return new PromiseDao(newList, getOrderManipulationAuthorityClient());
    }
